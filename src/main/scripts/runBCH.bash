...
echo "Running scripts BCH : ${__JAR_NAME}"
cd ${__REAL_PROJECTDIR}
nohup java -Dspring.profiles.active=PROD -Dspring.profiles.include=BCH -Dserver.port=10004 -jar ${__JAR_NAME} > ${__REAL_LOGDIR}/BCH.log &
